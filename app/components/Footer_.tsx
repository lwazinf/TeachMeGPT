import {
  ...
  const Footer_ = ({}: Footer_Props) => {
    ...
    return (
      <div
        className={`w-full min-h-[300px] flex flex-col justify-center items-center relative overflow-hidden`}
      >
        <div
          ...
          >
            ...
            >
              <div className={`text-[15px] font-black`}>
                <div
                  className={`bg-red-600 min-h-[50px] px-4 mb-2 flex flex-row justify-center items-end text-[20px] font-black cursor-default rounded-b-[2px] md:backdrop-blur-none backdrop-blur-md text-white duration-400 transition-all ml-[10px]`}
                >
                  Sho!
                </div>
              </div>
